...
python create_experiment_params.py --verbose --mod_order qpsk --protocol private_preamble --mod1 neural --mod2 neural \
--train_snr_db mid --num_trials 48 --batch_size 256 --experiment_name QPSK_neural_slow_vs_neural_slow \
...
cd ..
./runecho_args -b -n 2  -j ./experiments/private_preamble/QPSK_neural_slow_vs_neural_slow
...
./runecho_args -b -n 2  -j ./experiments/private_preamble/QPSK_neural_slow_vs_poly_fast
#cd experiments

#Poly fast vs poly fast
#python create_experiment_params.py --verbose --mod_order qpsk --protocol private_preamble --mod1 poly  --mod2 poly --train_snr_db mid --num_trials 48 --batch_size 256 --experiment_name QPSK_poly_fast_vs_poly_fast  --mod1_param_json $(pwd)/../custom_model_params/mod_poly_fast_params.json --demod1_param_json $(pwd)/../custom_model_params/demod_poly_fast_params.json   --mod2_param_json $(pwd)/../custom_model_params/mod_poly_fast_params.json   --demod2_param_json $(pwd)/../custom_model_params/demod_poly_fast_params.json --num_results_logged 10 --num_iterations 1500
...
#./runecho_args -b  -n 2 -j ./experiments/private_preamble/QPSK_poly_fast_vs_poly_fast
...
# ./runecho_args -b -n 2 -j ./experiments/private_preamble/QPSK_poly_slow_vs_poly_slow

# cd experiments

# #Poly fast vs poly slow

# python create_experiment_params.py --verbose --mod_order qpsk --protocol private_preamble --mod1 poly  --mod2 poly --train_snr_db mid --num_trials 48 --batch_size 256 --experiment_name QPSK_poly_fast_vs_poly_slow  --mod1_param_json $(pwd)/../custom_model_params/mod_poly_fast_params.json --demod1_param_json $(pwd)/../custom_model_params/demod_poly_fast_params.json   --mod2_param_json $(pwd)/../custom_model_params/mod_poly_slow_params.json   --demod2_param_json $(pwd)/../custom_model_params/demod_poly_slow_params.json --num_results_logged 10 --num_iterations 5000
...
# ./runecho_args -b -n 2 -j ./experiments/private_preamble/QPSK_poly_fast_vs_poly_slow

# cd experiments

# #Neural fast vs poly slow
# python create_experiment_params.py --verbose --mod_order qpsk --protocol private_preamble --mod1 neural  --mod2 poly --train_snr_db mid --num_trials 48 --batch_size 256 --experiment_name QPSK_neural_fast_vs_poly_slow --mod1_param_json $(pwd)/../custom_model_params/mod_neural_fast_params.json --demod1_param_json $(pwd)/../custom_model_params/demod_neural_fast_params.json   --mod2_param_json $(pwd)/../custom_model_params/mod_poly_slow_params.json   --demod2_param_json $(pwd)/../custom_model_params/demod_poly_slow_params.json --num_results_logged 10 --num_iterations 5000
...
# ./runecho_args -b -n 2 -j ./experiments/private_preamble/QPSK_neural_fast_vs_poly_slow
